...
import project_freq from "../images/project_freq.png";
import project_mips from "../images/project_mips.png";
...
const projects = [
  ...
  },
  {
    ...
    description:
      "32-bit pipelined MIPS processor with hazard detection, forwarding, and cache integration",
    tools: "Verilog",
  },
  {
    id: 1,
